...
<body>
    ...
    <div class="container my-3">
        ...
        <?php 
            $noResult = true;
            $query = $_GET["search"];
            $sql = "SELECT * FROM `user` WHERE MATCH(username,Address) against('$query') && usertype=1";
          ...
          $photo=$row['Photo'];
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="krkadmin/img/'.$photo. '" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                        <div class="card-body">
                            <h5 class="card-title"><a href="viewPizzaList.php?catid=' . $id . '">' . $username . '</a></h5>
                            <p class="card-text">' . substr($address, 0, 29). '...</p>
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/'.$image. '" class="card-img-top" alt="image for this pizza" width="249px" height="270px">
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                ...
                                echo '</form>
                                <a href="viewfood.php?pizzaid=' . $foodId . '"><button class="btn btn-primary">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
