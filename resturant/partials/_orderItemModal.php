<?php 
    $rid=$_SESSION["resturantId"];
    $itemModalSql = "SELECT * FROM `orders` WHERE resturantid='$rid'";
                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/krkfood/img/pizza-'.$image. '" alt="" width="70" class="img-fluid rounded shadow-sm">
