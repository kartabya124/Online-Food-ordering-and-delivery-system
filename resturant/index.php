<?php 
    session_start();
    if(isset($_SESSION['resturantloggedin']) && $_SESSION['resturantloggedin']==true){
        $resturantloggedin= true;
        $userId = $_SESSION['resturantId'];
    }
    else{
        $resturantloggedin = false;
        $userId = 0;
    }

    if($resturantloggedin) {
?>
<!doctype html>
<html lang="en">
<head>
...
<?php
        ...
        header("location: /krkfood/resturant/login.php");
    }
?>