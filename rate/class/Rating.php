...
class Rating{
    ...
    private $user  = 'root';
    private $password   = "";
    private $database  = "krkfood";    
	private $itemUsersTable = 'user';
	private $itemTable = 'user';	
	...
	public function getItemRating($itemId){
		$sqlQuery = "
			SELECT r.ratingId, r.itemId, r.userId, u.username,r.ratingNumber, r.title, r.comments, r.created, r.modified
